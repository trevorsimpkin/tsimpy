...
@section('content')
    <div class="col-lg-8">
        ...
        <!-- Date/Time -->
        <img class="img-responsive" src="/nqueensheader.png" width="800" alt="">
