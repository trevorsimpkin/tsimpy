...
@section('content')
    <div class="col-lg-8">
        ...
        <img class="img-responsive" src="/images/golgif.gif" width="800" alt="">

        <hr>

        <p class="lead">A graduate course in artificial intelligence at Brooklyn College sparked my interest in the various types of cellular automata. It fascinated me that a few simple rules could exhibit complex behaviors that imitate life. To learn more about Conway's Game of Life visit the <a href="https://en.wikipedia.org/wiki/Conway%27s_Game_of_Life">Wikipedia page</a>.</p>
