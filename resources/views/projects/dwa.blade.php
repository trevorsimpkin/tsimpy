...
@section('content')
    <div class="col-lg-8">
        ...
        <hr>
        <img class="img-responsive" src="/images/harvardportfolio.png" width="800" alt="Harvard Portfolio">
