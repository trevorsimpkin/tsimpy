...
@section('content')
    <div class="col-lg-8">
        ...
        <p>At the end of both summers I presented our findings at an annual undergraduate research conference. A PDF of my poster for the light scattering research can be downloaded <a href="#">here</a>. </p>
        <!-- Posted Comments -->
    </div>
